...
const tier3_commands = {
  ...
  giveCommand: {
    pattern: /((give|send|gift|trade)(.*)?(my|a)?) (stuff|prize(s)?|item(s)?|something|things(s)?|gift(s)?|inventory)/i
  },
  freePointsCommand: {
...
const tier4_conversational = {
  ...
  stopBeingHorny: {
    pattern: /((you|\bu\b)|(you are|you('|’)?re|your|ur)|stop|chill( with)?|knock off) (a|so|being( a| so)?|always)?\s?((lil|little)?\s?(bit)?)?\s?(horny|perverted|(a )?(perv(ert)?|freak(y)?))|((you|\bu\b) (get|got|need|have)( the)? horny pass)|(your|ur) (exhibitionism|horniness)/i
  }
};
...
const tier12_greetings = {
  ...
  goodbye: {
    pattern: /\b(by+e+|goodby+e+|good by+e+|see (ya+|you+|u)( later)?|byebye|by+e+ by+e+|see+y+a+|later+|cya|peace out)\b/i
  },
  greeting: {
    pattern: /\b(hey+o+|hi+|hey+|heww+o+|hell+o+|howdy+|hay+|yo+|hiy+a+|hey+a+|greetings|good evening|good afternoon)\b/i
  }
};
